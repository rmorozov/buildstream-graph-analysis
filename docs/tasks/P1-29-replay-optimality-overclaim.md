...
- `docs/cli.md:49`: "Run the deterministic replay scheduler to compute the optimal makespan ($T_C$) under perfect scheduling:"
- `docs/cli.md:54`: "`lpt` (Longest Processing Time first) - Default, often optimal."
...
## Verification Log
```
$ grep -n "optimal" bga/cli.py docs/cli.md bga/report/*.py bga/replay/*.py
bga/cli.py:280: ...not a claim of scheduling optimality (Part 18)
docs/cli.md:49: ...not a claim that $T_C$ is the mathematically optimal schedule:
docs/cli.md:54: ...not guaranteed optimal.
