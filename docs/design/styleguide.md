...
`UX-827` moved the small class's height bound 36,300 -> 36,900: the
distribution twin draws every mark the JSON carries, fifteen rows
where it drew nine - measured 35,900 -> 36,822 opened on `macro_micro`
