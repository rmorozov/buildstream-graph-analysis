...
**Priority:** High | **Status:** 🟢 Done Done | **Depends on:** UX-310 (the counter it un-closes), UX-368 (the queries it feeds wrong numbers) | **Serves:** anyone who takes the handoff and believes a number | **Topic:** capture
