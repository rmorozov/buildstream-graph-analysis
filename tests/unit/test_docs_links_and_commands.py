...
- **A link that does not resolve.** `UX-88` found a code comment
  pointing at `docs/backlog/scenarios/UX-26-...md` - a literal ellipsis - and a
  stderr message naming a scenario file that did not exist. Reorganising
...
Both are style-guide rules (`docs/style-guide.md`); these are the two
