...
Reading `docs/spec/specification.md` (as this task's own "Required Fix" section said to do before choosing between its two options) settled the question outright rather than leaving it a product decision:
