...
Read only: `sed -n '1201,1265p' docs/spec/specification.md` (Part 24 — Leaf and Deferrability Analysis, esp. 24.3's "leaf AND on observed blame chain or critical path AND not reachable from requested targets").
