...
[`docs/ingestion-pipeline.md`](ingestion-pipeline.md) for the full
...
[`UX-69`](scenarios/UX-69-plane-2-ranks-by-count-not-time.md) and
[`UX-73`](scenarios/UX-73-redundancy-findings-treat-the-unresolved-bucket-as-an-element.md);
...
- [`docs/architecture.md`](architecture.md) — how the two planes work and why they are not merged
- [`docs/optimization-walkthrough-06.md`](optimization-walkthrough-06.md) — the same cycle on a small project, written up as a case where the tool did *not* guide well
- [`docs/scenarios/README.md`](scenarios/README.md) — every behaviour above, with the evidence that produced it
