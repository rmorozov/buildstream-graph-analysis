...
- Documented the real limitation prominently in both code (each function's own docstring) and `docs/ingestion-pipeline.md`'s "A note on time-of-extraction consistency" section.
