...
**Priority:** Low | **Status:** 🔴 Not Started | **Depends on:** UX-341 (one unit per dimension), UX-215 (the element object) | **Serves:** a reader following a role to the payload that answers it | **Topic:** docs
