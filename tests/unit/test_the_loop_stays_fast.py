...
class TestTheSelectorStillSelects:
    ...
    #
    # `UX-683` added one test file naming `bga.findings`,
    # `bga.correlate`, `bga.graph.fan_in`, `bga.ingest.loader` and
    # `bga.ingest.models` - a module already at the widest selection
