...
**Priority:** High | **Status:** 🔴 Not Started | **Depends on:** UX-848, UX-856 | **Found by:** round 119, the user | **Serves:** R4 (an llvm-sized element alone on the critical path takes the whole machine) | **Topic:** capture | **Area:** tools | **Shape:** judgement
