...
934 scenarios: **23 open**, 911 closed.
...
| UX-939 | [the exercised line names an environment nothing can read, so a version bump in CI reds every branch](UX-0939-the-exercised-line-names-an-environment-nothing-can-read.md) | guards | High | every branch whose CI runs the bst tier | 🔴 Not Started |
