...
**Priority:** High | **Status:** 🟢 Done Done | **Found by:** round 69, an outside walk of `bga snapshot` → `bga view` → Perfetto | **Serves:** every future round that touches the trace or the query library | **Topic:** guards
