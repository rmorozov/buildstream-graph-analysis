...
**Priority:** Medium | **Status:** 🟢 Done Done | **Depends on:** UX-45 (real CPU time), UX-63 (peak RSS from the same struct) | **Serves:** anyone whose build is I/O-bound or contended rather than compute-bound | **Topic:** capture
