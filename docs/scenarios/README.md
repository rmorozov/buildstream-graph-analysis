...
| UX-12 | `bga` captures neither the real native `--max-jobs` value nor host CPU core count - can't even show "you're oversubscribed" per UX-09's own finding | High | UX-09 | 🔴 | [UX-12](UX-12-capture-native-max-jobs-and-host-cores.md) |
