...
## Spec Reference
`sed -n '1629,1719p' docs/spec/specification.md` (Part 33.3 Utilization Reconciliation) and I9 in `sed -n '1720,1780p' docs/spec/specification.md` (Part 34), plus `sed -n '904,996p' docs/spec/specification.md` (Part 15, cold floor / 15.3 publication gate) and `sed -n '1903,2132p' docs/spec/specification.md` (Part 36.10 for the exact cold-floor test cases the spec calls for).
