...
3. Keep the mapping's wording generic and structural (referencing the category's own defined meaning, e.g. via `docs/spec/specification.md` Part 11) - not build-system-specific advice that might not apply to every project shape.
