...
**Priority:** High | **Status:** 🟢 Done | **Depends on:** UX-147 (`probe_bwrap_shim`, which produces the advice), UX-11 (the shim, which is what needs somewhere executable to live)
