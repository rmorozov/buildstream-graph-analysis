...
No spec section — this is a robustness gap, not a spec-compliance one. `docs/guides/cli.md`'s exit-code table: `1` = bad args/missing files, `2` = ingestion failure (e.g. malformed JSON), `3` = analysis failure (cycles, `P2-01`).
