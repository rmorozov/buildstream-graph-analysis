...
[`UX-33`](scenarios/UX-33-text-report-withholds-critical-path-and-choke-point-names.md),
[`UX-34`](scenarios/UX-34-structural-elements-dominate-improvement-opportunities.md),
[`UX-36`](scenarios/UX-36-cpu-utilisation-block-reports-occupancy-not-cpu.md).
...
```
$ python3 -m tools.bst_native_build_tracer run --raw-log /tmp/06.rawlog \
...
as [`UX-32`](scenarios/UX-32-plane-2-has-no-per-element-achieved-parallelism.md).
...
([`UX-31`](scenarios/UX-31-notparallel-is-the-real-per-element-parallelism-control.md)).
...
([`UX-38`](scenarios/UX-38-tracer-report-accepts-the-wrong-artifact-silently.md)).
...
opposite of the fix ([`UX-35`](scenarios/UX-35-attribution-hints-are-capacity-blind.md)).
...
([`UX-30`](scenarios/UX-30-sweep-knee-point-stops-at-the-first-flat-step.md)).
