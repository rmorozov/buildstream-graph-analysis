...
**Priority:** Low | **Status:** 🟢 Fixed & Verified | **Depends on:** UX-280 (the Markdown preference), UX-223 (the accelerators), UX-334 | **Serves:** the keyboard and screen-reader reader | **Topic:** viewer
