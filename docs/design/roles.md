...
| R3 | **The graph owner** — owns the project's dependency shape | the structural answers: critical path, floors, what the graph makes impossible, junction/monorepo shape | a structure argument lost for lack of evidence | **Served.** Floors, chain-bound diagnosis, criticality, Direction 6's source axis |
