...
## Spec Reference
Part 10.2 (`sed -n '674,733p' docs/specification.md`): worked examples explicitly show phase annotations on non-execution categories - `IDLE / phase=cache_cleanup` and `SCHEDULER_WAIT / phase=load`.
