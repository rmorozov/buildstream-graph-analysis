...
**Priority:** High | **Status:** 🟢 Done Done | **Depends on:** UX-392 (the filters), UX-393 (the navigation), UX-396 (the drawings gap) | **Serves:** R2, and every reader of a seven-screen report | **Topic:** viewer
