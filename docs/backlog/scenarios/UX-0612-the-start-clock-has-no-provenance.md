...
**Priority:** High | **Status:** 🟢 Done | **Depends on:** UX-594 (which subtracts from it) | **Found by:** round 84, while building the queue seam | **Serves:** anyone computing a duration from a capture's start | **Topic:** capture
