...
`P1-02`, `P1-03`, `P1-04`, `P1-18`, `P1-19`, `P2-01`, `P2-02`, `P2-05`, and `P3-02` are now done (see Change Log). The whole "flattened timeline / attribution identity" family (`P1-03`, `P1-04`, `P1-19`) is now closed — attribution identity holds exactly on every fixture tested, including disconnected multi-terminal graphs and genuine idle gaps. Next up:

1. `P1-01` (real resource-holder tracking — now that `P1-03`/`P1-04`/`P1-19`'s ready-time/chain-walk fixes landed, this has a correct, stable baseline to build on)
