...
document on why (`docs/scenarios/UX-06-raw-log-timestamp-corruption.md`), then
extracted with `tools/bst_extract_run.py --format wrapped`:

```
$ python3 -m tools.bst_run_wrapped examples/04-critical-path-optimization \
    build-baseline-b2.log -- bst --builders 2 build all.bst
$ python3 -m tools.bst_extract_run --format wrapped \
...
convention (`docs/scenarios/UX-05`'s own ask) is for.

```
$ python3 -m tools.bst_run_wrapped examples/04-critical-path-optimization/optimized \
...
[`docs/scenarios/UX-06-raw-log-timestamp-corruption.md`](scenarios/UX-06-raw-log-timestamp-corruption.md)
...
[`docs/scenarios/UX-07-run-identity-collides-across-sibling-projects.md`](scenarios/UX-07-run-identity-collides-across-sibling-projects.md).
