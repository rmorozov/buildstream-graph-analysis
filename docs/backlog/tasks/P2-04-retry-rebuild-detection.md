...
Read only: `sed -n '1421,1475p' docs/spec/specification.md` (Part 30 — Utilisation Axis, esp. 30.2 Buckets: `useful, idle_no_tasks, idle_underparallel, wasted_retry, wasted_rebuild, untracked`).
