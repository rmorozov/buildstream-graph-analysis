...
**Priority:** High | **Status:** 🟢 Done Done | **Depends on:** UX-155 (the cwd lesson this module already recorded once), UX-376 (the census that should have refused) | **Serves:** R1, on the first capture they ever run | **Topic:** capture
