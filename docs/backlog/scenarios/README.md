...
| UX-1011 | [`--jobserver auto` pays three `bst show` calls before the build](UX-1011-jobserver-auto-pays-three-bst-show-calls-before-the-build.md) | capture | High | R4 | 🟡 In Progress |
