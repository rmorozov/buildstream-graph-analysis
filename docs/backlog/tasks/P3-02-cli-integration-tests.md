...
## Spec Reference
`sed -n '2133,2260p' docs/spec/specification.md` (Part 37 CLI, Part 38 Report Structure) for what output shape to expect. Also `docs/guides/cli.md` for the documented exit-code contract.
