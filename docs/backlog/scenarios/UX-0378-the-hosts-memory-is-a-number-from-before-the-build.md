...
**Priority:** High | **Status:** 🟢 Done Done | **Depends on:** UX-104 (memory-aware capacity advice), UX-243 (the memory envelope reaches no reader) | **Serves:** anyone whose build died and does not know why | **Topic:** capture
