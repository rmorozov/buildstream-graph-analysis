...
**Priority:** High | **Status:** 🟢 Done | **Depends on:** UX-01, UX-02, UX-03 (all done - this changes what the gate they built measures), UX-27 (the metric it needs), UX-40 (the confidence rule that currently disables it)
