...
**Priority:** High | **Status:** 🟢 Done Done | **Depends on:** UX-105 (measure the static-binary blind spot), UX-113 (--trace-spine=auto, guided by the census) | **Serves:** anyone whose project builds its own host tools | **Topic:** capture
