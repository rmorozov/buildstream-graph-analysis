...
915 scenarios: **20 open**, 895 closed.
...
| UX-917 | [hidden findings keep live controls](UX-0917-hidden-findings-keep-live-controls.md) | viewer | Medium | R1, R4 and assistive-technology users reading a report with many findings | 🔴 Not Started |
| UX-918 | [snapshot navigation and management need separate loci](UX-0918-snapshot-navigation-and-management-need-separate-loci.md) | viewer | Medium | R4, R5 and R7 readers maintaining a project's capture history | 🔴 Not Started |
