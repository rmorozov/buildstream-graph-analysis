...
## Spec Reference
Read only: `sed -n '1629,1719p' docs/spec/specification.md` (Part 33 — Reconciliation and Confidence) and the I4/I10 entries in `sed -n '1720,1780p' docs/spec/specification.md` (Part 34).
