...
| [130](../audits/round-130.md) | the control-growth and snapshot-management review: the 12-run window holds, hidden finding controls do not, and navigation stays in the rail while store guidance lives with Store evidence (`UX-917`, `UX-918`) |
